...
const VerifyUser = () => {
  ...
  return (
    <div className='w-[30%] p-4 mobile:shadow-none tablet:shadow-none  rounded-md   shadow-3xl text-center mobile:w-full tablet:w-[70%]'>
      ...
      <p className='my-2 text-[14px] text-slate-600'>Enter the 6-digit code send to your Email address</p>
       ...
       <p className='text-[14px] text-slate-800'>Don't recieve the OTP ? <span className='text-red-600'>Resend</span></p>
