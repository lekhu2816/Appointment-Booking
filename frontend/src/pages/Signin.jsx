      ...
      <div className=' p-5 w-1/2 tablet:w-3/4 mobile:w-full '>
        ...
        <form onSubmit={onHandleSubmit} className='flex flex-col gap-2 my-4'>
          ...
          <div className='px-2 py-1 flex gap-2 items-center border border-black rounded-sm'>
            ...
            <input onChange={onHandleChange} className='outline-none w-full' name='email' value={data.email} type="email" placeholder='Email' />
          </div>

          {/* Password Field */}
          <div className='mt-2 px-2 py-1 flex  items-center gap-2 border border-black rounded-sm'>
            <i className="fa-solid fa-lock"></i>
            <input onChange={onHandleChange} className='outline-none w-full' name='password' value={data.password} type={showPassword ? "text" : "password"} placeholder='Password' />
            <i 
