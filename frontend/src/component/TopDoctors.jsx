...
const TopDoctors = () => {
  ...
  return (
    <div className='flex flex-col items-center'>
        ...
        <button onClick={()=>{navigate('/doctors'),scrollTo(0,0)}} className='bg-blue-100 px-10 py-2 rounded-full text-sm transition-all duration-300 hover:scale-110 '>More</button>
    </div>
